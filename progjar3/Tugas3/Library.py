...
def get_url_list():
    urls = dict()
    urls['jotaro']='https://static.wikia.nocookie.net/jjba/images/9/99/KujoAnime.png/'
    urls['dio']='https://www.greenscene.co.id/wp-content/uploads/2020/11/dio-696x497.jpg'
    return urls
...
if __name__=='__main__':
    #check fungsi
    k = download_gambar('https://www.greenscene.co.id/wp-content/uploads/2020/11/dio-696x497.jpg')
    print(k)